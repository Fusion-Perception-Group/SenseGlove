...
void test_ffmt_parse()
{
    ...
    TEST_ASSERT_EQUAL(Placeholder::Center, phs[1].align);
    TEST_ASSERT_EQUAL(Placeholder::Decimal, phs[1].format);
    ...
    TEST_ASSERT_EQUAL(Placeholder::Right, phs[3].align);
    TEST_ASSERT_EQUAL(Placeholder::Scientific, phs[3].format);
